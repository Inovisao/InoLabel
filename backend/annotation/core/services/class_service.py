...
# 12 cores perceptualmente distintas (Tailwind 600) — unica fonte de verdade
CLASS_COLORS: list[str] = [
    "#2563EB", "#16A34A", "#EA580C", "#DC2626", "#9333EA", "#0D9488",
    "#CA8A04", "#DB2777", "#0891B2", "#65A30D", "#E11D48", "#4F46E5",
]
...
class ClassServiceMixin:
    ...
    def remove_class(self, name: str):
        ...
        # No backend a confirmacao e feita pelo frontend antes de chamar este metodo.
