"""Flet: toggles de modo — implementação autônoma sem herança Tkinter."""

from __future__ import annotations


class FletModeTogglesMixin:
    """
    Substitui ModeTogglesMixin para Flet.
    Todos os métodos de toggle são re-implementados sem acessar self.canvas.
    """

    def _clear_drawing_canvas_state(self):
        """Limpa o overlay de retângulo e reseta estado de desenho."""
        self.drawing_rect_id = None
        self.drawing_start = None
        if hasattr(self, "_hide_drawing_rect"):
            self._hide_drawing_rect()

    # Sobrescreve os toggles para usar _clear_drawing_canvas_state
